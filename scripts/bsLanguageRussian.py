...
values = {
    'accessToStorageDeviceDescription':('Для работы этой функции и полноценной работы модПака,\n'
                                        'модПаку нужен доступ к хранилищу Вашего устройства.\n\n'
                                        'После предоставления доступа появится папка "BombSquad".\n'
                                        'Путь к этой папке Вы можете узнать с помощью кнопки,\n'
                                        'которая называется "Показать папку модов" и находится\n'
                                        'по адресу: Главное меню - Настройки - Дополнительно.\n'
                                        'МодПак не будет красть ваши данные, создавать вирусы и т.п.!\n'
                                        'Если Вы читали соглашение на использование модПака,\n'
                                        'то там об этом написано.\n\n'
                                        'Нажимая кнопку "Предоставить", которая находится чуть ниже,\n'
                                        'Вы запускаете окно предоставления разрешения на доступ.\n'
                                        'В этом окне нажимаете кнопку "Разрешить" и всё заработает.\n'
                                        'Если Вы нажмете кнопку "Отклонить", то доступа у модПака\n'
                                        'не будет и, соответственно, эта функция и некоторые другие\n'
                                        'не заработают, пока Вы не разрешите доступ.'),
    'accessToStorageDeviceText':'Доступ к хранилищу устройства',
    'provideText':'Предоставить',
    'connectModPackServersError':('Ошибка, похоже Вы еще не получили данные для подключения.\n'
                                  'Попробуйте нажать кнопку "Обновить".'),
    'updateInfo':('Кнопки "МодПак-сервер (*тип*)" помогут Вам подключаться к этим серверам в один клик.\n'
                  'Но без специальных данных сделать они этого не смогут. Поэтому...\n'
                  'Сначала Вам нужно нажать на кнопку "Обновить", чтобы получить эти данные.\n'
                  'Результат получения данных может быть, а может и не быть из-за ошибки.\n'
                  'Если у Вас ошибка, то пишите нам в нашей группе ВКонтакте, попробуем помочь.\n'
                  'А также полученные данные активируют подсветку наших серверов во вкладке "Интернет".\n'
                  'Подсветка наших серверов поможет Вам найти именно наши сервера,\n'
                  'а не чужие с нашим названием.'),
    'updateInfoButton':'Информация',
    'updatePressInfoButton':'Чтобы узнать всю информацию по этим кнопкам, нажмите на кнопку "Информация".',
    'updateModPackServersSuccess':'МодПак-сервера обновлены.',
    'updateModPackServersError':'Не удалось обновить, похоже база данных не доступна.',
    'update':'Обновить',
    'agreement':'Соглашение на использование модПака',
    'agreementText':('СОГЛАШЕНИЕ НА ИСПОЛЬЗОВАНИЕ МОДПАКА\n\n'
                     'Последнее редактирование было 30 августа 2019\n\n'
                     ...
                     'English version:\n\n'
                     'AGREEMENT FOR USE OF MODPACK\n\n'
                     'Last edit was August 30 2019\n\n'
    ...
    'serverDataMsg':'Данные сервера:',
    'serverDataInfo':'Данные сервера - это его IP-адрес и порт.\nПеред заходом на сервер они будут написаны в чат.\nМожно также включить запись в файл этих данных.\nФайл с данными будет в папке модов.',
    'writeServerData':'Записывать в файл данные сервера при заходе',
    'showServerData':'Показывать данные сервера при заходе',
    'add':'Добавить',
    'act':'Действие',
    'newName':'Новое название...',
    'favoritesServerRenamed':'Сервер переименован.',
    'favoritesServerAdded':'Сервер добавлен в избранное.',
    'favoritesAlreadyServer':'Сервер с таким названием уже есть в избранном.\nПридумайте другое название.',
    'favoritesLastServerNone':'Вы еще не были ни на одном сервере.',
    'favoritesLastServerInFavorites':'Последний сервер на котором Вы были и так в избранном.',
    'favoritesLastServerAdded':'Последний сервер на котором Вы были добавлен в избранное.',
    'favoritesChatMenuAddButtonText':'Добавить сервер в избранное',
    'favoritesAndSoEmpty':'У Вас и так нет серверов в избранном.',
    'favoritesServerDeletedText':'Сервер удален из избранного.',
    'resetFavoritesSucces':'Все сервера удалены из избранного.',
    'deleteFavoritesConfirm':'Вы точно хотите удалить сервер из избранного?',
    'resetFavoritesConfirm':'Вы точно хотите удалить все сервера из избранного?',
    'favoritesInstructionText':('Как добавить сервер?\n' 
                                'Есть 2 варианта, но лучше пользоваться автоматическим.\n'
                                'Рассмотрим автоматический вариант:\n' 
                                '1. Зайди на нужный сервер\n' 
                                '2. Открой чат\n' 
                                '3. Нажми кнопку "..." в правом верхнем углу\n' 
                                '4. Нажми в открывшемся мини-окне кнопку "Добавить сервер в избранное"\n\n'
                                'Как видите, автоматический вариант простой. Второй вариант - это\n'
                                'добавление вручную, но он сложнее и расписывать его нет смысла.\n\n'
                                'Желаем приятного пользования.'),
    'favoritesInstructionButtonText':'Инструкция',
    'favoritesDeleteButtonText':'Удалить',
    'favoritesDeleteAllButtonText':'Удалить все',
    'favoritesAddButtonText':'Добавить вручную',
    'emptyFavoritesText':'У Вас нет серверов в избранном.',
    ...
    'powerupName21':'railgun - Рельсотрон',
    'powerupName22':'blessing - Благословение',
    ...
    'youNotLastMessage':'У Вас нет последнего сообщения.',
    ...
    'aboutBDWindow':{
        ...
        'creditsText2':('Разработчики-энтузиасты:\n'
                        ...
                        '\n'
                        '   Romtrap - на момент написания этого текста занимается\n'
                        '   серверами и группой ВК. Помощь в разработке модПака.\n'
                        ...
                        '\n'
                        '   DeadPool - занимался серверами и группой ВК.\n'
        ...
        'changeLogText':('                                                    ИСТОРИЯ ОБНОВЛЕНИЙ\n'
                        '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------—\n'
                        'Версия модПака: 1.8 Release\n'
                        'Версия основы: 1.4.146\n'
                        'Список обновлён: 30 августа 2019\n'
                        '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------—\n'
                        '\n'
                        '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------—\n'
                        'Список изменений для 1.8 Release\n'
                        '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------—\n'
                        '\n'
                        ...
                        'Важная информация: темы с версией движка 1.1 подойдут для 1.2!\n'
                        '\n'
                        'Добавления:\n'
                        '- Добавлен новый бонус "Рельсотрон"\n'
                        '- Добавлен новый бонус "Благословение"\n'
                        '- Добавлен новый персонаж "Гопник"\n'
                        '- Добавлена новая карта "Снежногорье"\n'
                        '- Добавлена новая сцена главного меню "Рикардо Милос"\n'
                        '- Добавлена кнопка информации в окно тем\n'
                        '- Добавлена кнопка для получения данных модПак-серверов\n'
                        '- Добавлена кнопка перехода к папке с темами в окно тем\n'
                        '- Добавлена новая вкладка "Избранное" в окне мультиплеера\n'
                        '- Добавлена новая подвкладка "Дополнительно" во вкладке "Интернет"\n'
                        '- Добавлено окно соглашения\n'
                        '- Добавлены новые разработчики в окно "О BombDash"\n'
                        '- Новая настройка "Показывать данные сервера при заходе"\n'
                        '- Новая настройка "Записывать в файл данные сервера при заходе"\n'
                        '\n'
                        'Исправления:\n'
                        '- Исправлен урон при поимке липучего привета\n'
                        '- Исправлен краш во время дня ВДВ\n'
                        '- Исправлена работа команды /bot\n'
                        '- Исправлена ссылка на наш сайт везде\n'
                        '- Исправлено выпадение артиллерии из бонуса лего\n'
                        '- Исправлено выделение наших серверов, если база данных недоступна\n'
                        '- Исправлено управление интерфейсом кнопками во многих окнах\n'
                        '- Исправлены яйца в главном меню во время Пасхи\n'
                        '- Исправления в хоккее\n'
                        '- Исправления в переводах\n'
                        '- Исправления в высоком прыжке\n'
                        '- Исправления в дополнительном ускорителе\n'
                        '- Исправления крашей, а может и нет\n'
                        '\n'
                        'Прочее:\n'
                        '- Автоматический перезапуск окна статистики после сброса\n'
                        '- Отключены турниры, опять да\n'
                        '- Перенесены кнопки подключения к модПак-серверам\n'
                        '- Возвращена и улучшена команда /fly3d\n'
                        '- Новое сокращение команды /iceOff - /io\n'
                        '- Изменения в структуре описания команд\n'
                        '- Изменения и исправления в сцене на весь экран\n'
                        '- Изменения и исправления в показании меню для клиентов хоста\n'
                        '- Удален ненужный перевод\n'
                        '- Удалена версия движка в окне тем\n'
                        '- Удалена проверка модов и их удаление\n'
                        '- Удалено сообщение о перезагрузке для некоторых настроек\n'
                        '- Удалено получение данных модПак-серверов при запуске модПака\n'
                        '- Удален и переделан запрос доступа к памяти при запуске модПака\n'
                        '- Оптимизация запуска модПака\n'
    ...
    'tournamentsText':'Нельзя играть в турниры с модами :(',
    'translations':{
        'characterNames':{

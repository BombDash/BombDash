...
class TeamsScoreScreenActivity(bsGame.ScoreScreenActivity):
    ...
    def showPlayerScores(
        ...
        def _txt(
                ...
                maxWidth=120.0):
            bsUtils.Text(text, color=gLobbyTextColor,
        ...
        def _scoreTxt(text, xOffs, highlight, delay, maxWidth=70.0):
            bsUtils.Text(
                ...
                position=(tsHOffs + xOffs * scale, tsVOffset + (vOffs + 15)
                          * scale),
                scale=scale, color=eval(gLobbyScoreLeadersTextColor), hAlign='right',
    ...
    def onBegin(self):
        ...
        def _scoreTxt(
            ...
            return bsUtils.Text(text,
                                ...
                                color=eval(gLobbyScoreTextColor),
                                hAlign='right',
                                transition='inLeft',
        ...
        title = bsUtils.Text(
            ...
            hAlign='center', color=gLobbyTextColor,
            transition='inLeft', transitionDelay=tDelay).autoRetain()
        ...
        for i, player in enumerate(playerOrderPrev):
            ...
            txtNum = bsUtils.Text(
                ...
                hAlign='right', color=gLobbyTextColor,
                transition='inLeft', transitionDelay=tDelay).autoRetain()
            bs.gameTimer(
                tDelay + delay3, bs.WeakCall(
...
class TeamVictoryScoreScreenActivity(TeamsScoreScreenActivity):
    ...
    def onBegin(self):
        ...
        bsUtils.ZoomText(bestTxt,
                         ...
                         scale=0.25,
                         color=gLobbyTextColor, jitter=3.0).autoRetain()
...
class TeamSeriesVictoryScoreScreenActivity(TeamsScoreScreenActivity):
    ...
    def onBegin(self):
        ...
        bsUtils.Text(txt,
                     vAlign='center',
                     maxWidth=300,
                     color=gLobbyTextColor, position=(0, 220),
        ...
        if mkp is not None:
            ...
            bsUtils.Text(
                ...
                hAlign='left', scale=0.6, color=gLobbyTextColor,
                transition='inLeft', transitionDelay=t).autoRetain()
            t += 4*tIncr
            bsUtils.Image(
                mkp.getIcon(),
...
class TeamJoiningActivity(bsGame.JoiningActivity):
    ...
    def onTransitionIn(self):
        ...
        self._nextUpText = bsUtils.Text(
            ...
            position=(0, -70),
            flash=False, color=gLobbyTextColor,

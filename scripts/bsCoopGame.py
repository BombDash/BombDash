...
class CoopScoreScreen(bs.Activity):
    ...
    def onTransitionIn(self):
        ...
        self._background = bsUtils.Background(
            fadeTime=450, startFaded=False, showLogo=False)
    ...
    def showUI(self):
        ...
        if bsUtils.gRunningKioskModeGame:
            ...
            self._powerRankingButtonInstance = bsUI.PowerRankingButton(
                ...
                size=(100, 60),
                scale=0.9, color=powerRankingButtonColor,
                textColor=powerRankingButtonTextColor,
            ...
            self._storeButtonInstance = bsUI.StoreButton(
                ...
                scale=0.9, buttonType='square', color=gButtonsColor,
                textColor=gButtonsTextColor, isGame=True,
                transitionDelay=0)
    ...
    def onBegin(self):
        ...
        bsUtils.ZoomText(
            ...
            maxWidth=800, flash=False, trail=False, color=gLobbyTextColor,
        ...
        if self._showFriendScores:
            ...
            for i in range(displayCount):
                ...
                if displayScores[i] == ourScore and not showedOurs:
                    flash = True
                    color0 = gLobbyScoreTextColor2
                    color1 = gLobbyTextColor
                    tDelay1 = 3700
                    tDelay2 = 3700
                    showedOurs = True
                else:
...
def fillOutCampaigns():
    ...
    c.addLevel(
        bs.Level(
            ...
            previewTexName='doomShroomPreview'))
    c.addLevel(bs.Level('Boss Battle', displayName='Boss Battle', gameType=ericBoss.BossBattleGame2, settings={}, previewTexName='roofMapPreview'))
    c.addLevel(
        bs.Level(
    ...
    internalModules = ['bsNinjaFight', 'bsMeteorShower',
                       'bsTargetPractice', 'bsEasterEggHunt','ericBoss']

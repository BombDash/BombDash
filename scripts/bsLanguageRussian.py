...
values = {
    ...
    'favoritesInstructionText':('Как добавить сервер?\n' 
								'Есть 2 варианта.\n'
		                        'Рассмотрим вариант вручную:\n'
								'1. Тебе нужно каким-то образом узнать ip-адрес и порт нужного сервера\n' 
								'2. Далее нажать кнопку в избранном "Добавить вручную"\n' 
								'3. Ну и далее думаю понятно\n'
								'(конечно надо сделать способ получения ипа и порта, но пока хз как)\n' 
								'\n'
								'А теперь рассмотрим автоматический вариант:\n' 
    ...
    'aboutBDWindow':{
        ...
        'changeLogText':('                                                    ИСТОРИЯ ОБНОВЛЕНИЙ\n'
                        ...
                        'Список обновлён: 1 августа 2019\n'
                        '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------—\n'
                        '\n'
                        '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------—\n'

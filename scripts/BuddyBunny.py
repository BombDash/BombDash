...
class BunnyBuddyBot(bsSpaz.SpazBot):
    ...
    def __init__(self, player):
        ...
        bsSpaz.Spaz.__init__(self, color=self.color, highlight=self.highlight, character=player.character,
...
class BunnyBotSet(bsSpaz.BotSet):
    ...
    def setBunnyText(self, spaz):
        ...
        spaz._bunnyText = bs.newNode('text', owner=spaz.node, attrs={
            'text': self.sourcePlayer.getName()+' bot',
            'inWorld': True,
            'shadow': 1.0,
            'flatness': 1.0,

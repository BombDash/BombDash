    ...
    def createDisplay(
        ...
        if inGameColors:
            ...
            objs.append(bsUtils.Text(
                ...
                hAttach=hAttach,
                vAttach=vAttach,
                color=(achievementsCompleteNamesColor if complete
                       else (achievementsNotCompleteNamesColor[0],
                             achievementsNotCompleteNamesColor[1],
                             achievementsNotCompleteNamesColor[2], (0.2 if hmo else 0.4))),
                transitionDelay=delay+50,
                transitionOutDelay=None).autoRetain())
            objs.append(bsUtils.Text(
                ...
                color=(achievementsCompleteDescriptionColor
                       if complete
                       else(
                    achievementsNotCompleteDescriptionColor[0],
                    achievementsNotCompleteDescriptionColor[1],
                    achievementsNotCompleteDescriptionColor[2], (0.2 if hmo else 0.4))),
                transitionDelay=delay + 100,
                transitionOutDelay=None).autoRetain())
        return objs
...
# BombDash achievements
gAchievements.append(
    Achievement('Social', 'vkLogo',
                (0.101946, 0.643044, 0.999855), '', 5))

gAchievements.append(
    Achievement('Fair', 'levelIcon',
        (0.101946, 0.643044, 0.999855), '', 5))

gAchievements.append(
    Achievement('Boss', 'trophy',
        (0.2, 0.8, 1), '', 5))

    ...
    def _readEntries(self):
        ...
        try:
            ...
            class SpawnSpaz(object):
                def __init__(self,num,position,color=(1,1,1),highlight=(1,1,1),makeCurrent=False,relativeTo=None,name='',flash=True, angle=0,character='Easter Bunny'):
                    self._num = num
                ...
                def run(self,a):
                    ...
                    s = a._spazzes[self._num] = bs.Spaz(color=self._color, highlight=self._highlight, startInvincible=self._flash, demoMode=True,character = self._character)
                    #s.node.name = bs.getSpecialChar('dragon')+bs.Lstr(resource='dev1').evaluate()
            ...
            self._entries = [Reset(),
                             SpawnSpaz(0,(0,5.5,-3.0),color=(10,15,12),highlight=(0.1,0.1,0.5),makeCurrent=True,name=bs.Lstr(resource='dev2').evaluate()),
                             DelayOld(1000),
                             ...
                             SpawnSpaz(0,(-0.09249162673950195, 4.337906360626221, -2.3),makeCurrent=True,flash=False,name=bs.Lstr(resource='dev3').evaluate(),color=(1,13,15),highlight=(0,0,0)),
                             SpawnSpaz(1,(-3.1, 4.3, -2.0),makeCurrent=False,color=(11,1.3,0),highlight=(0,2.6,0.7),
                                       # name=R.randomName1Text),
                                       name=bs.Lstr(resource='dev1')),
                             Move(-1.0,0),
                             DelayOld(1050),
                             Move(0,-0.01),
                             DelayOld(100),
                             ...
                             DelayOld(100),
                             Move(0,0),
                             Text(bs.Lstr(resource=self._r+'.phrase07Text',subs=[('${NAME}',bs.Lstr(resource='dev1'))])), # see that didnt hurt fred
                             DelayOld(2000),
                             ...
                             SpawnSpaz(0,(-3.2, 4.3, -4.4),makeCurrent=True,flash=False,name=bs.Lstr(resource='dev6').evaluate(),color=(0.1,0.1,0.1),highlight=(0,0,0.4)),
                             SpawnSpaz(1,(3.3, 4.2, -5.8),makeCurrent=False,color=(3,0.1,0),highlight=(3,1,0),character='Mel',
                                       name=bs.Lstr(resource='dev5')),
                             DelayOld(1800),
                             ...
                             SpawnSpaz(0,(2.368781805038452, 4.337533950805664, -4.360159873962402),makeCurrent=True,flash=False,name=bs.Lstr(resource='dev7').evaluate(),color=(20,0,20),highlight=(0,0,0.4)),
                             SpawnSpaz(1,(-3.2, 4.3, -4.5),makeCurrent=False,color=(6,4,0),highlight=(2.98,0.21,0.82),
                                       # name=R.randomName3Text),
                                       name=bs.Lstr(resource='dev4')),
                             DelayOld(100),
                             ...
                             Text(bs.Lstr(resource=self._r+'.phrase13Text',subs=[('${NAME}',bs.Lstr(resource='dev4'))])), # whoops sorry bill
                             RemoveGloves(),
                             DelayOld(2000),
                             AnalyticsScreen('Tutorial Section 5'),
                             Text(bs.Lstr(resource=self._r+'.phrase14Text',subs=[('${NAME}',bs.Lstr(resource='dev5'))])), # you can pick up and throw things such as chuck here
                             SpawnSpaz(0,(-4.0, 4.3, -2.5),makeCurrent=True,flash=False,angle=90,name=bs.Lstr(resource='dev2').evaluate(),color=(10,15,12),highlight=(0.1,0.1,0.5)),
                             SpawnSpaz(1,(5,0,-1.0),relativeTo=0,makeCurrent=False,color=(3,0.1,0),highlight=(3,1,0),character='Mel',
                                       # name=R.randomName4Text),#dev4 color=(6,4,0),highlight=(2.98,0.21,0.82) #dev5 color=(3,0.1,0),highlight=(3,1,0),character='Mel'
                                       name=bs.Lstr(resource='dev5')),
                             DelayOld(1000),
                             ...
                             SpawnSpaz(0,(1.5, 4.3, -4.0),makeCurrent=True,flash=False,angle=0,name=bs.Lstr(resource='dev3').evaluate(),color=(1,13,15),highlight=(0,0,0)),
            ...
            DelayOld2(10),MoveLR(-0.70983),JumpRelease(),DelayOld2(30),MoveLR(-0.592181),MoveUD(-0.0588092),DelayOld2(10),MoveLR(-0.490219),MoveUD(-0.0744957),DelayOld2(10),MoveLR(-0.41963),DelayOld2(20),MoveLR(0),MoveUD(0),DelayOld2(20),MoveUD(0),
                             ...
                             SpawnSpaz(0,(-0.7, 4.3, -3.9),makeCurrent=True,flash=False,angle=-30,name=bs.Lstr(resource='dev3').evaluate(),color=(1,13,15),highlight=(0,0,0)),
                             SpawnSpaz(1,(6.5,0,-0.75),relativeTo=0,makeCurrent=False,color=(6,4,0),highlight=(2.98,0.21,0.82),
